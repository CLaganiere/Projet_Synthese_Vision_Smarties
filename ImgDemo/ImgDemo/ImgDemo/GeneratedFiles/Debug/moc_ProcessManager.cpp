...
QT_MOC_LITERAL(1, 15, 12), // "imgProcessed"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "img_t"
QT_MOC_LITERAL(4, 35, 5), // "image"
QT_MOC_LITERAL(5, 41, 9) // "imgFinale"

    },
    "ProcessManager\0imgProcessed\0\0img_t\0"
    "image\0imgFinale"
};
...
void ProcessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imgProcessed((*reinterpret_cast< const img_t(*)>(_a[1]))); break;
        case 1: _t->imgFinale((*reinterpret_cast< const img_t(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProcessManager::*)(img_t const & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessManager::imgProcessed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ProcessManager::*)(img_t const & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessManager::imgFinale)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ProcessManager::imgProcessed(img_t const & _t1)
{
...
// SIGNAL 1
void ProcessManager::imgFinale(img_t const & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
